...
const ValueScreen6 = ({ navigation, route, onNext }: any) => {
  const valueIndex = route?.params?.valueIndex ?? 5;
        ...
        <View style={styles.container}>
          ...
          <View style={styles.illustrationContainer}>
            <View style={styles.animationWrapper}>
              {LottieView ? (
                <LottieView
                  source={animations.businessManWinner}
                  autoPlay
                  loop
          ...
          <View style={styles.contentContainer}>
            <Text style={styles.title}>
              Conquer <Text style={styles.titleBold}>Yourself</Text>
            </Text>
            <Text style={styles.description}>
              Self‑awareness is the key to freedom. PuffNoMore helps you
              recognize your habits, overcome cravings, and stay in control.
            </Text>
