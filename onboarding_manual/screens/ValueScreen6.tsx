...
const ValueScreen6 = ({ navigation, route, onNext }: any) => {
  const valueIndex = route?.params?.valueIndex ?? 5; // sixth screen
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          ...
          <View style={styles.illustrationContainer}>
            {LottieView ? (
              <LottieView
                source={animations.businessManWinner} // replace with actual key if needed
                autoPlay
                loop
          ...
          <View style={styles.contentContainer}>
            <Text style={styles.heading}>Conquer yourself</Text>
            <Text style={styles.description}>
              Know yourself to conquer yourself. Understand your{" "}
              <Text style={styles.bold}>strengths and weaknesses</Text>, earn
              medals, and track your progress.
            </Text>
          </View>
