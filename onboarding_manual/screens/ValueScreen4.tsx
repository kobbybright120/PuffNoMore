...
const ValueScreen4 = ({ navigation, route, onNext }: any) => {
  const valueIndex = route?.params?.valueIndex ?? 3; // fourth screen
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          ...
          <View style={styles.animationContainer}>
            {LottieView ? (
              <LottieView
                source={animations.meditatingBrain} // meditation animation
                autoPlay
                loop
          ...
          <View style={styles.contentContainer}>
            ...
            <Text style={styles.description}>
              Quitting porn can be challenging. Your daily check-in keeps you
              motivated as you become your best self.
            </Text>
          </View>
