...
const ValueScreen4 = ({ navigation, route, onNext }: any) => {
  const valueIndex = route?.params?.valueIndex ?? 3;
        ...
        <View style={styles.container}>
          ...
          <View style={styles.illustrationContainer}>
            <View style={styles.animationWrapper}>
              {LottieView ? (
                <LottieView
                  source={animations.meditatingBrain}
                  autoPlay
                  loop
          ...
          <View style={styles.contentContainer}>
            <Text style={styles.title}>
              Stay <Text style={styles.titleBold}>Motivated</Text>
            </Text>
            <Text style={styles.description}>
              Quitting smoking works best with encouragement. PuffNoMore keeps
              you motivated as you cut back, regain control, and become your
              best self.
            </Text>
