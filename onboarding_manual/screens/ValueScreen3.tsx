...
const ValueScreen3 = ({ navigation, route, onNext }: any) => {
  const valueIndex = route?.params?.valueIndex ?? 2;
        ...
        <View style={styles.container}>
          ...
          <View style={styles.contentContainer}>
            <Text style={styles.title}>
              Rewire your <Text style={styles.titleBold}>Brain</Text>
            </Text>
            <Text style={styles.description}>
              Science‑backed techniques help you cut down gradually. Each step
              retrains your brain, restores balance, and makes cravings easier
              to resist.
            </Text>
